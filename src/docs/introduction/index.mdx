...
- [Header](/docs/components-header--docs): Generic USWDS Header wrapper with optional extended layout and navigation slots
...
- [Person](/docs/components-person--docs): Profile block for individuals with avatar, name, role, department, contact actions, meta, and tags
...
For more details, see the i18n docs in `src/i18n/README.md`.
