...
export interface ColorSwatchProps {
  ...
  name: string;
  /**
   * Optional description or hex value
   */
  description?: string;
}
 ...
 */
export const RedColorSwatches: React.FC = () => {
  return (
 ...
 */
export const OrangeColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const GoldColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const YellowColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const GreenColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const MintColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const CyanColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
 ...
 */
export const BlueColorSwatches: React.FC = () => {
  return (
    <div className="p-6 bg-[var(--portland-background-color)] text-[var(--portland-text-color)]">
