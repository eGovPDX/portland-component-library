...
`+e.id,s=Yt.get(i);return s||(s=Ft(o.absoluteBoundingBox,e.absoluteBoundingBox),Yt.set(i,s)),[...s.map(n=>mr({guide:n,reverseScale:t})),...s.map(n=>gr({guide:n,reverseScale:t,fontSize:r}))]},Gt=A`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`;var et=({node:o,selected:e=!1,computedThickness:t,onClick:r})=>{let{x:i,y:s,width:n,height:c}=o.absoluteBoundingBox,a="cornerRadius"in o&&o.cornerRadius?{topLeft:o.cornerRadius,topRight:o.cornerRadius,bottomRight:o.cornerRadius,bottomLeft:o.cornerRadius}:"rectangleCornerRadii"in o&&o.rectangleCornerRadii?{topLeft:o.rectangleCornerRadii[0],topRight:o.rectangleCornerRadii[1],bottomRight:o.rectangleCornerRadii[2],bottomLeft:o.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},d=t/2,l=(m,x)=>`M${m},${x}`,h=(m,x)=>`L${m},${x}`,u=(m,x,E)=>`A${m},${m} 0 0 1 ${x},${E}`,f=[l(a.topLeft+d,d),h(n-a.topRight,d),u(a.topRight-d,n-d,a.topRight),h(n-d,c-a.bottomRight),u(a.bottomRight-d,n-a.bottomRight,c-d),h(a.bottomLeft,c-d),u(a.bottomLeft-d,d,c-a.bottomLeft),h(d,a.topLeft),u(a.topLeft-d,a.topLeft,d),"Z"].join(" ");return C`
    <path
      class="guide"
      d=${f}
      shape-rendering="geometricPrecision"
...
`;var Er=[{gte:31536e6,divisor:31536e6,unit:"year"},{gte:2592e6,divisor:2592e6,unit:"month"},{gte:6048e5,divisor:6048e5,unit:"week"},{gte:864e5,divisor:864e5,unit:"day"},{gte:36e5,divisor:36e5,unit:"hour"},{gte:6e4,divisor:6e4,unit:"minute"},{gte:3e4,divisor:1e3,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],ro=o=>(typeof o=="object"?o:new Date(o)).getTime(),io=(o,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{let i=ro(e)-ro(o),s=Math.abs(i);for(let n of Er)if(s>=n.gte){let c=Math.round(Math.abs(i)/n.divisor),a=i<0,d=n.unit;return d?t.format(a?c:-c,d):n.text}};var so=A`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
...
`,no=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return b`<a
  ...
  >
    ...
    >
      Edited ${io(t)}
  ...
  </a>`};var ao=function(o,e,t,r){var i=arguments.length,s=i<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(n=o[c])&&(s=(i<3?n(s):i>3?n(e,t,s):n(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s},k=function(o,e,t,r){if(t==="a"&&!r)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?o!==e||!r:!e.has(o))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?r:t==="a"?r.call(o):r?r.value:e.get(o)},tt=function(o,e,t,r,i){if(r==="m")throw new TypeError("Private method is not writable");if(r==="a"&&!i)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?o!==e||!i:!e.has(o))throw new TypeError("Cannot write private member to an object whose class did not declare it");return r==="a"?i.call(o,t):i?i.value=t:e.set(o,t),t},_e=o=>{var e,t,r,i,s;class n extends Dt(Vt(o)){constructor(...a){super(...a),this.zoomMargin=50,this.link="",e.set(this,void 0),t.set(this,void 0),r.set(this,void 0),i.set(this,d=>l=>{l.preventDefault(),l.stopPropagation(),this.selectedNode=d}),s.set(this,d=>{var l,h;return(h=(l=k(this,r,"f"))===null||l===void 0?void 0:l.find(u=>u.id===d))!==null&&h!==void 0?h:null})}static get styles(){let a=super.styles;return ve(a,[A`
          :host {
        ...
        "
          >
            ${Object.entries(this.__images).map(([f,m])=>{var x;let E=k(this,s,"f").call(this,f);if(!E||!("absoluteBoundingBox"in E)||!(!((x=k(this,t,"f"))===null||x===void 0)&&x[E.id]))return null;let _=k(this,t,"f")[E.id];return b`
                <img
                  class="rendered-image"
                  src="${m}"
                  style=${Y({top:`${E.absoluteBoundingBox.y-a.y}px`,left:`${E.absoluteBoundingBox.x-a.x}px`,marginTop:`${-_.top}px`,marginLeft:`${-_.left}px`,width:E.absoluteBoundingBox.width+_.left+_.right+"px",height:E.absoluteBoundingBox.height+_.top+_.bottom+"px"})}
                />
              `})}
            ...
            >
              ...
              ${k(this,r,"f").map(f=>{var m;return f.id===((m=this.selectedNode)===null||m===void 0?void 0:m.id)?null:C`
                  <g>
                    ${et({node:f,computedThickness:h*d,onClick:k(this,i,"f").call(this,f)})}
    ...
    `}getMetadata(){return{fileName:this.documentNode.name,timestamp:this.documentNode.lastModified,link:this.link}}connectedCallback(){super.connectedCallback(),this.documentNode&&(ot(this,we,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom()))}updated(e){super.updated(e),e.has("documentNode")&&(ot(this,we,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom())),e.has("renderedImages")&&this.__updateEffectMargins()}};we=new WeakMap,rt=new WeakMap;co([S({type:Object,attribute:"document-node"})],D.prototype,"documentNode",void 0);co([S({type:Object,attribute:"rendered-images"})],D.prototype,"renderedImages",void 0);customElements.get("figspec-file-viewer")||customElements.define("figspec-file-viewer",D);customElements.get("figspec-frame-viewer")||customElements.define("figspec-frame-viewer",F);var Mr=new Set(["children","localName","ref","style","className"]),ho=new WeakMap,Pr=(o,e,t,r,i)=>{let s=i?.[e];s===void 0||t===r?t==null&&e in HTMLElement.prototype?o.removeAttribute(e):o[e]=t:((n,c,a)=>{let d=ho.get(n);d===void 0&&ho.set(n,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),n.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),n.removeEventListener(c,l))})(o,s,t)},Tr=(o,e)=>{typeof o=="function"?o(e):o.current=e};function $e(o=window.React,e,t,r,i){let s,n,c;if(e===void 0){let f=o;({tagName:n,elementClass:c,events:r,displayName:i}=f),s=f.react}else s=o,c=t,n=e;let a=s.Component,d=s.createElement,l=new Set(Object.keys(r??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(m){if(this.o!==null)for(let x in this.i)Pr(this.o,x,this.props[x],m?m[x]:void 0,r)}componentDidMount(){var m;this.t(),(m=this.o)===null||m===void 0||m.removeAttribute("defer-hydration")}componentDidUpdate(m){this.t(m)}render(){let{_$Gl:m,...x}=this.props;this.h!==m&&(this.u=_=>{m!==null&&Tr(m,_),this.o=_,this.h=m}),this.i={};let E={ref:this.u};for(let[_,ke]of Object.entries(x))Mr.has(_)?E[_==="className"?"class":_]=ke:l.has(_)||_ in c.prototype?this.i[_]=ke:E[_]=ke;return E.suppressHydrationWarning=!0,d(n,E)}}h.displayName=i??c.name;let u=s.forwardRef((f,m)=>d(h,{...f,_$Gl:m},f?.children));return u.displayName=h.displayName,u}var po=$e(le,"figspec-frame-viewer",F,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),uo=$e(le,"figspec-file-viewer",D,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var Qc=__STORYBOOK_API__,{ActiveTabs:ed,Consumer:td,ManagerContext:od,Provider:rd,RequestResponseError:id,addons:Se,combineParameters:sd,controlOrMetaKey:nd,controlOrMetaSymbol:ad,eventMatchesShortcut:ld,eventToShortcut:cd,experimental_MockUniversalStore:dd,experimental_UniversalStore:hd,experimental_requestResponse:pd,experimental_useUniversalStore:ud,isMacLike:fd,isShortcutTaken:md,keyToSymbol:gd,merge:vd,mockChannel:yd,optionOrAltSymbol:bd,shortcutMatchesShortcut:xd,shortcutToHumanString:_d,types:it,useAddonState:wd,useArgTypes:$d,useArgs:Sd,useChannel:Ed,useGlobalTypes:Ad,useGlobals:Cd,useParameter:st,useSharedState:kd,useStoryPrepared:Md,useStorybookApi:Pd,useStorybookState:fo}=__STORYBOOK_API__;var Nr=Object.defineProperty,ct=(o,e)=>()=>(o&&(e=o(o=0)),e),Rr=(o,e)=>{for(var t in e)Nr(o,t,{get:e[t],enumerable:!0})},Ce,mo,go,vo,dt=ct(()=>{Ce=({config:o,defer:e=!1})=>{let[t,r]=P(e?void 0:o.url),[i,s]=P(!1);return N(()=>{if(!e)return;let n=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(n)},[e,o.url]),N(()=>{s(!1)},[t]),p("div",{css:mo},!i&&p(I,{css:go},"Loading..."),p("iframe",{css:vo,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>s(!0)}))},mo=T`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Ur=T`
  ...
  bottom: 0;
  left: 0;
`,Fr=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(w,null,p(ce,{onClick:o},p(de,{icon:"zoom"})),p(ce,{onClick:e},p(de,{icon:"zoomout"})),p(ce,{onClick:t},p(de,{icon:"zoomreset"}))),Dr=(o,e)=>{let[t,r]=P(1);N(()=>{r(o)},e);let i=M(()=>{r(c=>c+.1)},[r]),s=M(()=>{r(c=>Math.max(c-.1,.1))},[r]),n=M(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:s,resetZoom:n}},jr=({config:o})=>{let e=Dr(o.scale||1,[o.scale]),t=W(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:zr},p(pt,{border:!0},p(w,{key:"left"},p("p",null,p("b",null,"Image")),p(ut,null),p(Fr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut}))),p(Hr,{css:Vr,defaultValue:o.offset},p("img",{css:Yr,src:o.url,style:t})))},zr=T`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Wr=({config:o})=>p("div",{css:Gr},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Gr=T`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
