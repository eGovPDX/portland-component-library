...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    Se.Fragment = k, Se.jsx = function(i, l, b, x, E) {
...
var fe = yr(), je = { exports: {} }, Fe = { exports: {} }, F = {};
...
function br() {
  ...
  return F.AsyncMode = m, F.ConcurrentMode = u, F.ContextConsumer = f, F.ContextProvider = s, F.Element = t, F.ForwardRef = d, F.Fragment = r, F.Lazy = D, F.Memo = T, F.Portal = n, F.Profiler = o, F.StrictMode = a, F.Suspense = h, F.isAsyncMode = function(p) {
    return j(p) || I(p) === m;
  }, F.isConcurrentMode = j, F.isContextConsumer = function(p) {
    return I(p) === f;
    ...
    return typeof p == "string" || typeof p == "function" || p === r || p === u || p === o || p === a || p === h || p === y || typeof p == "object" && p !== null && (p.$$typeof === D || p.$$typeof === T || p.$$typeof === s || p.$$typeof === f || p.$$typeof === d || p.$$typeof === _ || p.$$typeof === N || p.$$typeof === L || p.$$typeof === k);
  }, F.typeOf = I, F;
}
var M = {};
/** @license React v16.13.1
...
function vr() {
  return qt || (qt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function I(g) {
      ...
      g === r || g === u || g === o || g === a || g === h || g === y || typeof g == "object" && g !== null && (g.$$typeof === D || g.$$typeof === T || g.$$typeof === s || g.$$typeof === f || g.$$typeof === d || g.$$typeof === _ || g.$$typeof === N || g.$$typeof === L || g.$$typeof === k);
    }
    function j(g) {
    ...
    var p = m, q = u, K = f, te = s, xe = t, Ee = d, ne = r, de = D, Ae = T, G = n, me = o, W = a, H = h, se = !1;
    function pe(g) {
    ...
    M.AsyncMode = p, M.ConcurrentMode = q, M.ContextConsumer = K, M.ContextProvider = te, M.Element = xe, M.ForwardRef = Ee, M.Fragment = ne, M.Lazy = de, M.Memo = Ae, M.Portal = G, M.Profiler = me, M.StrictMode = W, M.Suspense = H, M.isAsyncMode = pe, M.isConcurrentMode = i, M.isContextConsumer = l, M.isContextProvider = b, M.isElement = x, M.isForwardRef = E, M.isFragment = S, M.isLazy = P, M.isMemo = w, M.isPortal = A, M.isProfiler = C, M.isStrictMode = R, M.isSuspense = Y, M.isValidElementType = I, M.typeOf = j;
  }()), M;
}
var Gt;
function Cn() {
...
function Ar() {
  if (Jt) return Ze;
  Jt = 1;
  var e = Cn(), t = xr(), n = /* @__PURE__ */ Tt(), r = /* @__PURE__ */ Rn(), a = /* @__PURE__ */ Er(), o = function() {
  };
  ...
  return Ze = function(f, m) {
    ...
    function _(i) {
      ...
      function x(S, P, w, A, C, R, Y) {
        ...
        return P[w] == null ? S ? P[w] === null ? new k("The " + C + " `" + R + "` is marked as required " + ("in `" + A + "`, but its value is `null`.")) : new k("The " + C + " `" + R + "` is marked as required in " + ("`" + A + "`, but its value is `undefined`.")) : null : i(P, w, A, C, R);
      }
      var E = x.bind(null, !1);
      return E.isRequired = x.bind(null, !0), E;
    }
    function N(i) {
      function l(b, x, E, S, P, w) {
        var A = b[x], C = W(A);
        if (C !== i) {
          var R = H(A);
          return new k(
            "Invalid " + S + " `" + P + "` of type " + ("`" + R + "` supplied to `" + E + "`, expected ") + ("`" + i + "`."),
            { expectedType: i }
          );
        }
        return null;
    ...
    function I(i) {
      function l(b, x, E, S, P) {
        if (typeof i != "function")
          return new k("Property `" + P + "` of component `" + E + "` has invalid PropType notation inside arrayOf.");
        var w = b[x];
        if (!Array.isArray(w)) {
          var A = W(w);
          return new k("Invalid " + S + " `" + P + "` of type " + ("`" + A + "` supplied to `" + E + "`, expected an array."));
        }
        for (var C = 0; C < w.length; C++) {
          var R = i(w, C, E, S, P + "[" + C + "]", n);
    ...
    function j() {
      function i(l, b, x, E, S) {
        var P = l[b];
        if (!f(P)) {
          var w = W(P);
          return new k("Invalid " + E + " `" + S + "` of type " + ("`" + w + "` supplied to `" + x + "`, expected a single ReactElement."));
        }
        return null;
      }
      return _(i);
    ...
    function p() {
      function i(l, b, x, E, S) {
        ...
        if (!e.isValidElementType(P)) {
          var w = W(P);
          return new k("Invalid " + E + " `" + S + "` of type " + ("`" + w + "` supplied to `" + x + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return _(i);
    ...
    function q(i) {
      function l(b, x, E, S, P) {
        if (!(b[x] instanceof i)) {
          ...
          return new k("Invalid " + S + " `" + P + "` of type " + ("`" + A + "` supplied to `" + E + "`, expected ") + ("instance of `" + w + "`."));
        }
        return null;
      }
      return _(l);
    ...
    function K(i) {
      ...
      function l(b, x, E, S, P) {
        ...
        return new k("Invalid " + S + " `" + P + "` of value `" + String(w) + "` " + ("supplied to `" + E + "`, expected one of " + C + "."));
      }
      return _(l);
    }
    function te(i) {
      function l(b, x, E, S, P) {
        if (typeof i != "function")
          return new k("Property `" + P + "` of component `" + E + "` has invalid PropType notation inside objectOf.");
        var w = b[x], A = W(w);
        if (A !== "object")
          return new k("Invalid " + S + " `" + P + "` of type " + ("`" + A + "` supplied to `" + E + "`, expected an object."));
        for (var C in w)
          if (r(w, C)) {
            var R = i(w, C, E, S, P + "." + C, n);
            if (R instanceof Error)
    ...
    function xe(i) {
      ...
      function x(E, S, P, w, A) {
        for (var C = [], R = 0; R < i.length; R++) {
          var Y = i[R], g = Y(E, S, P, w, A, n);
          if (g == null)
            return null;
          g.data && r(g.data, "expectedType") && C.push(g.data.expectedType);
        }
        var V = C.length > 0 ? ", expected one of type [" + C.join(", ") + "]" : "";
        return new k("Invalid " + w + " `" + A + "` supplied to " + ("`" + P + "`" + V + "."));
      }
      return _(x);
    }
    function Ee() {
      function i(l, b, x, E, S) {
        return G(l[b]) ? null : new k("Invalid " + E + " `" + S + "` supplied to " + ("`" + x + "`, expected a ReactNode."));
      }
      return _(i);
    }
    function ne(i, l, b, x, E) {
      return new k(
        (i || "React class") + ": " + l + " type `" + b + "." + x + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + E + "`."
      );
    }
    function de(i) {
      function l(b, x, E, S, P) {
        var w = b[x], A = W(w);
        if (A !== "object")
          return new k("Invalid " + S + " `" + P + "` of type `" + A + "` " + ("supplied to `" + E + "`, expected `object`."));
        for (var C in i) {
          var R = i[C];
          if (typeof R != "function")
            return ne(E, S, P, C, H(R));
          var Y = R(w, C, E, S, P + "." + C, n);
          if (Y)
            return Y;
        }
        return null;
      ...
      function l(b, x, E, S, P) {
        ...
        for (var R in C) {
          ...
          if (r(i, R) && typeof Y != "function")
            return ne(E, S, P, R, H(Y));
          if (!Y)
            return new k(
              "Invalid " + S + " `" + P + "` key `" + R + "` supplied to `" + E + "`.\nBad object: " + JSON.stringify(b[x], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(i), null, "  ")
            );
          var g = Y(w, R, E, S, P + "." + R, n);
          if (g)
            return g;
        }
        return null;
...
let wt = {}, In = {}, Nn = null, jn = {
  mark: en,
  measure: en
};
try {
  typeof window < "u" && (wt = window), typeof document < "u" && (In = document), typeof MutationObserver < "u" && (Nn = MutationObserver), typeof performance < "u" && (jn = performance);
} catch {
}
const {
  userAgent: tn = ""
} = wt.navigator || {}, ae = wt, z = In, nn = Nn, Me = jn;
ae.document;
...
const Z = "___FONT_AWESOME___", ft = 16, Yn = "fa", $n = "svg-inline--fa", ce = "data-fa-i2svg", lt = "data-fa-pseudo-element", Qr = "data-fa-pseudo-element-pending", _t = "data-prefix", kt = "data-icon", on = "fontawesome-i2svg", ea = "async", ta = ["HTML", "HEAD", "STYLE", "SCRIPT"], Wn = (() => {
  try {
...
const na = Ce(Un), ct = c({}, Dr);
ct[$] = c(c(c(c({}, {
  duotone: "fad"
}), ct[$]), an.kit), an["kit-duotone"]);
const sn = Ce(ct), ut = c({}, it);
ut[$] = c(c({}, ut[$]), Wr.kit);
const Ct = Ce(ut), dt = c({}, Hr);
dt[$] = c(c({}, dt[$]), Yr.kit);
Ce(dt);
const ra = kr, qn = "fa-layers-text", aa = Cr, oa = c({}, jr);
Ce(oa);
const ia = ["class", "data-prefix", "data-icon", "data-fa-transform", "data-fa-mask"], et = Rr, sa = [...zr, ...Kr], Te = ae.FontAwesomeConfig || {};
function fa(e) {
...
function pt(e, t) {
  ...
  typeof J.hooks.addPack == "function" && !r ? J.hooks.addPack(e, cn(t)) : J.styles[e] = c(c({}, J.styles[e] || {}), a), e === "fas" && pt("fa", t);
}
const {
  styles: ke,
  shims: Ea
...
function He(e) {
  ...
  let r = null;
  const a = st.concat(qr), o = un(e.filter((h) => a.includes(h))), s = un(e.filter((h) => !st.includes(h))), f = o.filter((h) => (r = h, !Dn.includes(h))), [m = null] = f, u = wa(o), d = c(c({}, _a(s)), {}, {
    prefix: Ge(m, {
      family: u
    })
  });
...
function Ia(e) {
  ...
  if (!f && (m || u || d) && (r.prefix = "fad"), (t.includes("fa-brands") || t.includes("fab")) && (r.prefix = "fab"), !r.prefix && Ca.includes(n) && (Object.keys(o).find((y) => Ra.includes(y)) || s.autoFetchSvg)) {
...
function Ft(e) {
  const {
    ...
    width: y,
    height: T
  } = n.found ? n : t, D = $r.includes(r), k = [v.replacementClass, a ? "".concat(v.cssPrefix, "-").concat(a) : ""].filter((p) => d.classes.indexOf(p) === -1).filter((p) => p !== "" || !!p).concat(d.classes).join(" ");
  let _ = {
    children: [],
  ...
  h && (_.attributes[ce] = ""), f && (_.children.push({
    tag: "title",
    attributes: {
  ...
  return L.children = I, L.attributes = j, s ? $a(L) : Ya(L);
}
function mn(e) {
  const {
    content: t,
...
const pn = () => {
  ...
  mark: pn,
  measure: pn
}, Pe = 'FA "6.7.2"', Ga = (e) => (vt.mark("".concat(Pe, " ").concat(e, " begins")), () => ir(e)), ir = (e) => {
...
function eo(e) {
  ...
  let a = He(Rt(e));
  return a.prefix || (a.prefix = oe()), t && n && (a.prefix = t, a.iconName = n), a.iconName && a.prefix || (a.prefix && r.length > 0 && (a.iconName = Pa(a.prefix, e.innerText) || jt(a.prefix, mt(e.innerText))), !a.iconName && v.autoFetchSvg && e.firstChild && e.firstChild.nodeType === Node.TEXT_NODE && (a.iconName = e.firstChild.data)), a;
}
function to(e) {
...
function vn(e) {
  ...
  if (f.length > 0)
    ...
    return Promise.resolve();
  const m = Mt.begin("onTree"), u = f.reduce((d, h) => {
    try {
      const y = cr(h);
      y && d.push(y);
    } catch (y) {
...
function io(e) {
  return function(t) {
    ...
    return a && (a = (a || {}).icon ? a : ht(a || {})), e(r, c(c({}, n), {}, {
      mask: a
    }));
  };
}
const so = function(e) {
  ...
  return Ve(c({
    ...
    iconDefinition: e,
    params: t
  }), v.autoA11y && (s ? u["aria-labelledby"] = "".concat(v.replacementClass, "-title-").concat(f || _e()) : (u["aria-hidden"] = "true", u.focusable = "false")), Ft({
    icons: {
      main: yt(T),
      mask: a ? yt(a.icon) : {
        found: !1,
...
const mo = new RegExp('"', "ug"), xn = [1105920, 1112319], En = c(c(c(c({}, {
  FontAwesome: {
    normal: "fas",
    400: "fas"
  }
...
function An(e, t) {
  ...
  return new Promise((r, a) => {
    if (e.getAttribute(n) !== null)
      return r();
    const s = ve(e.children).filter((y) => y.getAttribute(lt) === t)[0], f = ae.getComputedStyle(e, t), m = f.getPropertyValue("font-family"), u = m.match(aa), d = f.getPropertyValue("font-weight"), h = f.getPropertyValue("content");
    if (s && !u)
    ...
    if (u && h !== "none" && h !== "") {
      ...
      const {
        value: D,
        isSecondary: k
      } = go(y), _ = u[0].startsWith("FontAwesome");
      let N = jt(T, D), L = N;
      if (_) {
        const I = Ta(D);
        I.iconName && I.prefix && (N = I.iconName, T = I.prefix);
      }
      if (N && !k && (!s || s.getAttribute(_t) !== T || s.getAttribute(kt) !== L)) {
        e.setAttribute(n, L), s && e.removeChild(s);
        const I = no(), {
          extra: j
        } = I;
        j.attributes[lt] = t, bt(N, T).then((p) => {
          const q = Ft(c(c({}, I), {}, {
            icons: {
              main: p,
              mask: ar()
  ...
  hooks() {
    return {
      ...
      watch(e) {
        ...
        Sn ? xt() : yn(gt("mutationObserverCallbacks", {
          observeMutationsRoot: t
        }));
      }
    };
  ...
  provides(e) {
    e.generateAbstractMask = function(t) {
      ...
      const {
        ...
        children: [Tn(c({
          tag: u.tag,
          attributes: c(c({}, u.attributes), y.path)
        }, D))]
      }, _ = {
        tag: "g",
        attributes: c({}, y.outer),
...
}, To = [ya, fo, lo, co, uo, vo, xo, Eo, Oo, So, Po];
Fa(To, {
  mixoutsTo: U
});
U.noAuto;
...
function jo(e) {
  var t, n = e.beat, r = e.fade, a = e.beatFade, o = e.bounce, s = e.shake, f = e.flash, m = e.spin, u = e.spinPulse, d = e.spinReverse, h = e.pulse, y = e.fixedWidth, T = e.inverse, D = e.border, k = e.listItem, _ = e.flip, N = e.size, L = e.rotation, I = e.pull, j = (t = {
    "fa-beat": n,
    "fa-fade": r,
    "fa-beat-fade": a,
    "fa-bounce": o,
  ...
  var r = (t.children || []).map(function(m) {
    ...
    switch (u) {
      ...
      case "style":
        ...
        break;
      default:
        u.indexOf("aria-") === 0 || u.indexOf("data-") === 0 ? m.attrs[u.toLowerCase()] = d : m.attrs[ur(u)] = d;
    }
    return m;
  }, {
    attrs: {}
...
var kn = {
  ...
  transform: null,
  swapOpacity: !1
}, Lt = /* @__PURE__ */ Pt.forwardRef(function(e, t) {
  var n = X(X({}, kn), e), r = n.icon, a = n.mask, o = n.symbol, s = n.className, f = n.title, m = n.titleId, u = n.maskId, d = _n(r), h = ot("classes", [].concat(Ot(jo(n)), Ot((s || "").split(" ")))), y = ot("transform", typeof n.transform == "string" ? At.transform(n.transform) : n.transform), T = ot("mask", _n(a)), D = wo(d, X(X(X(X({}, h), y), T), {}, {
    symbol: o,
    title: f,
    titleId: m,
    maskId: u
...
var Yo = dr.bind(null, Pt.createElement);
/*!
 * Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com
 * License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)
 * Copyright 2024 Fonticons, Inc.
...
const $o = {
  ...
  const d = ["usa-search", e === "big" ? "usa-search--big" : e === "small" ? "usa-search--small" : "", n].filter(Boolean).join(" "), h = (y) => {
    y.preventDefault(), s && s(y);
  };
  return /* @__PURE__ */ fe.jsx("section", { "aria-label": `${e} search component`, children: /* @__PURE__ */ fe.jsxs("form", { className: d, role: "search", onSubmit: h, children: [
    /* @__PURE__ */ fe.jsx("label", { className: "usa-sr-only", htmlFor: r, children: t }),
    /* @__PURE__ */ fe.jsx(
      "input",
      {
        className: "usa-input",
    ...
    /* @__PURE__ */ fe.jsx("button", { className: "usa-button", type: "submit", children: e === "small" ? /* @__PURE__ */ fe.jsx(
      Lt,
      {
        icon: Wo,
    ...
    ) : /* @__PURE__ */ fe.jsx("span", { className: "usa-search__submit-text", children: t }) })
  ] }) });
};
Uo.propTypes = {
